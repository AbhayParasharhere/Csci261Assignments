...
//	the most significant digits from the number.
//	Free the memory from the pointer 'number'.
//	Point the new word by the pointer 'number'.
...
//Return TRUE if all the digits of the number are either zero or one or point(.).
...
//Return TRUE if all the digits of the number are one of the decimal digits or a point(.) .
